...
import github.madmarty.madsonic.provider.SearchSuggestionProvider1;
...
public class SettingsActivity extends PreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    //    if (Constants.PREFERENCES_KEY_LANGUAGE.equals("de")) {
    //    	Util.changeLanguage(this, language.getValue().toString());
    //    	Log.d(TAG, "Language: " + language.getValue().toString());
    //    }
